...
public class EmloyeeeJDBC {
	...
	try {
		...
		Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/employeeSTS","root","Pass123@@");
  ...
  //	System.out.println("Table Created successfully");
		...
		prestatement.setString(2, "Pandharinath");
		prestatement.setInt(3, 82081120);
		prestatement.setString(4, "MH");
		prestatement.setString(5,"pandharinathdhandare@gmail.com");
